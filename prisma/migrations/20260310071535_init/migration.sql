...
CREATE TABLE "new_Character" (
    ...
    "name" TEXT NOT NULL,
    "world" TEXT NOT NULL,
    "fflogsCanonicalId" TEXT,
    "createdAt" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" DATETIME NOT NULL,
    CONSTRAINT "Character_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User" ("id") ON DELETE CASCADE ON UPDATE CASCADE
);
INSERT INTO "new_Character" ("createdAt", "fflogsCanonicalId", "id", "name", "updatedAt", "userId", "world") SELECT "createdAt", "fflogsCanonicalId", "id", "name", "updatedAt", "userId", "world" FROM "Character";
