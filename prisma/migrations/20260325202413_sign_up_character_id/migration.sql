/*
  ...
  - Added the required column `characterId` to the `EventSignup` table without a default value. This is not possible if the table is not empty.
...
INSERT INTO "new_EventSignup" ("availableFrom", "availableTo", "createdAt", "dailyLimit", "helperProgPoints", "id", "isHelper", "partiesAssigned", "progPoint", "sessionId", "status", "updatedAt", "userId", "willingness") SELECT "availableFrom", "availableTo", "createdAt", "dailyLimit", "helperProgPoints", "id", "isHelper", "partiesAssigned", "progPoint", "sessionId", "status", "updatedAt", "userId", "willingness" FROM "EventSignup";
